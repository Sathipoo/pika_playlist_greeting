...
viewer_pdf_mir = Template("""<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Pikachooz playlist greeting</title>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Lobster&display=swap');
        @import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@700&display=swap');
        body {
        ...
        .message {
            ...
            /* box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); */
            text-align: center;
            font-family: 'Comfortaa', 'Parisienne', 'Sacramento', 'Marck Script';
        }
        ...
        .section-1 .song-name {
            /* styles for song in section Anisuthide  */
        }
        ...
        .section-4 .lyrics {
            ...
            width: 96%;
            padding-left: 2%;
            text-shadow: 1px 1px rgb(209, 205, 205);
            font-weight: 400;
        }
